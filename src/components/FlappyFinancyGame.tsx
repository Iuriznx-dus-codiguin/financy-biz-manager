...
const FlappyFinancyGame = () => {
  ...
  }, [player, obstacles, score, highScore, gameState]);
      ...
      <CardContent className="p-6 text-center">
        ...
        <div className="relative mb-4">
          <canvas
            ...
            width={800}
            height={400}
            className="border-2 border-purple-200 dark:border-purple-600 rounded-lg bg-gradient-to-b from-blue-400 to-green-400 cursor-pointer max-w-full"
            onClick={jump}
          ...
          {gameState === 'idle' && (
            <div className="absolute inset-0 flex items-center justify-center bg-black/50 rounded-lg">
              <div className="text-center text-white">
                ...
                <h2 className="text-2xl font-bold mb-4">Flappy Financy</h2>
                <p className="mb-4">Clique ou use ESPAÇO para pular</p>
                <Button
                  onClick={startGame}
